...
#define OJ_STRDUP(str) oj_strdup(str, __FILE__, __LINE__)
#define OJ_STRNDUP(str, len) oj_strndup(str, len, __FILE__, __LINE__)

#define OJ_FREED(ptr) oj_freed(ptr, __FILE__, __LINE__)
...
extern char*	oj_strdup(const char *str, const char *file, int line);
extern char*	oj_strndup(const char *str, size_t len, const char *file, int line);
extern void	oj_freed(void *ptr, const char *file, int line);
...
#define OJ_STRNDUP(str, len) strndup(str, len)
#define OJ_FREED(ptr) {}
