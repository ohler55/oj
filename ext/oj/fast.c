...
void oj_init_doc(void) {
    ...
    rb_define_singleton_method(oj_doc_class, "open", RUBY_METHOD_FUNC(doc_open), 1);
    rb_define_singleton_method(oj_doc_class, "open_file", RUBY_METHOD_FUNC(doc_open_file), 1);
    rb_define_singleton_method(oj_doc_class, "parse", RUBY_METHOD_FUNC(doc_open), 1);
    rb_define_method(oj_doc_class, "where?", RUBY_METHOD_FUNC(doc_where_q), 0);
    rb_define_method(oj_doc_class, "where", RUBY_METHOD_FUNC(doc_where), 0);
    rb_define_method(oj_doc_class, "path", RUBY_METHOD_FUNC(doc_path), 0);
    rb_define_method(oj_doc_class, "local_key", RUBY_METHOD_FUNC(doc_local_key), 0);
    rb_define_method(oj_doc_class, "home", RUBY_METHOD_FUNC(doc_home), 0);
    rb_define_method(oj_doc_class, "type", RUBY_METHOD_FUNC(doc_type), -1);
    rb_define_method(oj_doc_class, "fetch", RUBY_METHOD_FUNC(doc_fetch), -1);
    rb_define_method(oj_doc_class, "exists?", RUBY_METHOD_FUNC(doc_exists), 1);
    rb_define_method(oj_doc_class, "each_leaf", RUBY_METHOD_FUNC(doc_each_leaf), -1);
    rb_define_method(oj_doc_class, "move", RUBY_METHOD_FUNC(doc_move), 1);
    rb_define_method(oj_doc_class, "each_child", RUBY_METHOD_FUNC(doc_each_child), -1);
    rb_define_method(oj_doc_class, "each_value", RUBY_METHOD_FUNC(doc_each_value), -1);
    rb_define_method(oj_doc_class, "dump", RUBY_METHOD_FUNC(doc_dump), -1);
    rb_define_method(oj_doc_class, "size", RUBY_METHOD_FUNC(doc_size), 0);
    rb_define_method(oj_doc_class, "close", RUBY_METHOD_FUNC(doc_close), 0);

    rb_define_method(oj_doc_class, "clone", RUBY_METHOD_FUNC(doc_not_implemented), 0);
    rb_define_method(oj_doc_class, "dup", RUBY_METHOD_FUNC(doc_not_implemented), 0);
}
